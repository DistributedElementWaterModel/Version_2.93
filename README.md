## DistributedElementWaterModel 2.93
Spatially distributed hydrological model with land surface characteristics based on N50 geospatial data from Norwegian Mapping Authority
