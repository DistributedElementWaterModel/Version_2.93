...
int main(int argc, char *argv[])
{
  ...
  /*  cout << "\n File with watercourses/catchments identifiers: ";
      cin >> fileName;
      cout << endl;*/
  ...
  fileWCo >> numCatch;
  cout << " # Number of watercourses/catchmentss: " << numCatch << endl;
  ...
  /*  cout << "\n File with grid cell watercourses/catchments identifiers: ";
      cin >> fileName;
      cout << endl; */
  fileControl.ignore(100,':');
  fileControl >> fileName;
